...
class kb_cobrapy(object):
    ...
    def model_to_sbml_file(self, params, context=None):
        """
        ...
        """
        return self._client.run_job('kb_cobrapy.model_to_sbml_file',
                                    [params], self._service_ver, context)

    def export_model_as_sbml(self, params, context=None):
        """
        ...
        :returns: instance of type "ExportOutput" -> structure: parameter
           "shock_id" of String
        """
        return self._client.run_job('kb_cobrapy.export_model_as_sbml',
                                    [params], self._service_ver, context)

    def status(self, context=None):
        return self._client.run_job('kb_cobrapy.status',
