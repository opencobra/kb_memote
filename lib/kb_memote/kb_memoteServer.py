...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_memote'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_memote.kb_memoteImpl import kb_memote  # noqa @IgnorePep8
impl_kb_memote = kb_memote(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_memote'
